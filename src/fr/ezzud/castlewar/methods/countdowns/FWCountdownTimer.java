...
public class FWCountdownTimer implements Runnable {
    ...
    private Consumer<FWCountdownTimer> everySecond;
    private Runnable beforeTimer;
    private Runnable afterTimer;

    public FWCountdownTimer(JavaPlugin plugin, int seconds,
                          Runnable beforeTimer, Runnable afterTimer,
                          Consumer<FWCountdownTimer> everySecond) {
        this.plugin = plugin;
